//Sam Verma
//Process Scheduler - ProcessScheduler.java
...
public abstract class ProcessScheduler 
{
    ...
    //Print a time chart of the results
    //Blank represents idle time
    ...
    //Go through the process queue (sorted by arrival time) and create a new process queue using the selected scheduling algorithm
